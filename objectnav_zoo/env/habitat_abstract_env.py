...
import objectnav_zoo.core.abstract_env

ActType = TypeVar("ActType")


class HabitatEnv(objectnav_zoo.core.abstract_env.Env):
    """
    Base environment that lets a objectnav_zoo agent interact with the Habitat
    simulator.

    Subclasses need to implement translation from Habitat observations into
    objectnav_zoo observations and from objectnav_zoo actions back into Habitat
    actions.
    """
    ...
    def apply_action(
        self,
        action: objectnav_zoo.core.interfaces.Action,
        info: Optional[Dict[str, Any]] = None,
        prev_obs: Optional[objectnav_zoo.core.interfaces.Observations] = None,
    ):
        if info is not None:
    ...
    def get_observation(self) -> objectnav_zoo.core.interfaces.Observations:
        return self._last_obs
